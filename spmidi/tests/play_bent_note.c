/* $Id: play_bent_note.c,v 1.4 2007/10/02 16:24:50 philjmsl Exp $ */
/**
 *
 * Extremely simple test that just plays a few notes with pitch bend.
...
#define LOWEST_PITCH        (75)
#define PITCH_INCR          (20)
#define HIGHEST_PITCH       (75)
#define CHANNEL             (0)
#define DURATION            (SAMPLE_RATE/20)
